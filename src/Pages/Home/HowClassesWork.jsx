...
//     {
//       id: 1,
//       title: t("class.steps.title"),
//       icon: User,
//       description: t("class.steps.description"),
//       color: "bg-gray-100",
...
//             <Link to={"/register"} className="w-full sm:w-auto bg-yellow-400 hover:bg-yellow-500 text-white px-6 sm:px-8 py-3 rounded-full font-semibold transform transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl text-sm sm:text-base">
//               Get Started Today
//             </Link>
...
const HowClassesWork = () => {
  ...
  const steps = [
    {
      id: 1,
      title: t("class.steps.0.title"),
      icon: User,
      description: t("class.steps.0.description"),
      color: "bg-gray-100",
      iconColor: "text-gray-600"
    },
    {
      id: 2,
      title: t("class.steps.1.title"),
      icon: HelpCircle,
      description: t("class.steps.1.description"),
      color: "bg-yellow-400",
      iconColor: "text-white"
    },
    {
      id: 3,
      title: t("class.steps.2.title"),
      icon: FileText,
      description: t("class.steps.2.description"),
      color: "bg-gray-800",
      iconColor: "text-white"
    },
    {
      id: 4,
      title: t("class.steps.3.title"),
      icon: ThumbsUp,
      description: t("class.steps.3.description"),
      color: "bg-gray-100",
      iconColor: "text-gray-600"
    }
  ];
  ...
  return (
    <div className={`min-h-screen bg-gradient-to-br from-gray-50 to-white py-8 sm:py-12 lg:py-16 px-4 sm:px-6 lg:px-8 ${i18n.language === 'ar' ? 'text-right' : 'text-left'}`}>
      <div className="max-w-7xl mx-auto">
        {/* Header Section */}
        <div className="text-center mb-12 sm:mb-16">
          <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4 sm:mb-6 leading-tight">
            ...
            return (
              ...
              >
                ...
                <div className="text-center transform transition-all duration-300 hover:scale-105 px-2 sm:px-4">
                  ...
                  {/* Step Number and Title */}
                  <div className="mb-3 sm:mb-4">
                    <h3 className="text-lg sm:text-xl flex items-center justify-center font-semibold text-gray-900 mb-2 leading-tight">
                      <span className="text-yellow-500">{step.id}.</span>
                      <span className={`block ${i18n.language === 'ar' ? 'mr-2' : 'ml-2'}`}>
                        {step.title}
                      </span>
                    </h3>
                  </div>
        ...
        <div className="text-center mt-12 sm:mt-16">
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4 px-4">
            <Link 
              to="/register" 
              className="w-full sm:w-auto bg-yellow-400 hover:bg-yellow-500 text-white px-6 sm:px-8 py-3 rounded-full font-semibold transform transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl text-sm sm:text-base"
            >
              {t("class.cta")}
            </Link>
          </div>
