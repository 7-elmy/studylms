...
//             // src="https://www.youtube.com/watch?v=aK46A6jQ1RM" 
//             type="video/mp4" 
//           />
...
// const VideoPlayer = ({ url="https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4" }) => {
...
export default function IntroSection({ url = "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4" }) {
  const [isPlaying, setIsPlaying] = useState(true);
  const [isMuted, setIsMuted] = useState(true);
  const [isVisible, setIsVisible] = useState(false);
  ...
  return (
    <section className="relative h-screen w-full overflow-hidden bg-[#222222]/80 pt-12 md:pt-0">
      {/* Video Background */}
      <div className="absolute inset-0 w-full h-full">
        {isDirectVideo ? (
          <video
