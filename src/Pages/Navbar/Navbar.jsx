...
const Header = () => {
    ...
    const [selectedLanguage, setSelectedLanguage] = React.useState(localStorage.getItem("language") || "en");
                        ...
                        <div className="flex items-center justify-between h-16 lg:h-20">
                            ...
                            <nav className="hidden lg:flex items-center space-x-8">
                                {menuItems.map((item, index) => (
                                    <div key={index} className="relative group">
                                        <Link
                                            to={item.href}
                                            className="text-gray-700 hover:text-blue-600 uppercase text-sm font-medium flex items-center py-2 transition-colors"
                                        >
                                            {item.name}
                                        </Link>
                                        
                                        {item.submenu && (
                                            <div className={`absolute ${i18n.language =="ar" ? "right-0" :"left-0"}  mt-0 w-48 bg-white rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50`}>
                                                <div className="py-2">
                                ...
                                <div className="hidden lg:flex items-center space-x-4">
                                    ...
                                    <div className="relative">
                                        <button
                                            ...
                                            className="flex items-center space-x-2 text-gray-600 hover:text-blue-600 p-2 transition-colors"
                                        >
                                            <img 
                            ...
                            <div className="lg:hidden flex items-center space-x-2">
                                ...
                                <div className="relative">
                                    <button
                                        onClick={handleLanguageDropdownToggle}
                                        className="flex items-center text-gray-600 hover:text-blue-600 p-2 transition-colors"
                                    >
                                        <img 
                                            src={getCurrentLanguage().flag} 
                                            alt={getCurrentLanguage().name}
                                        ...
                                        <div key={index}>
                                            <div className="flex items-center justify-between">
                                                <a
                                                    ...
                                                    className="block px-4 py-3 text-gray-700 hover:text-blue-600 hover:bg-gray-50 uppercase text-sm font-medium flex-1 transition-colors"
                                                ...
                                                {item.submenu && (
                                                    <button
                                                        ...
                                                        className="px-4 py-3 text-gray-500 hover:text-blue-600 transition-colors"
                                                    >
                                                ...
                                                <div className="bg-gray-50">
                                                    {item.submenu.map((subItem, subIndex) => (
                                                        <a
                                                            key={subIndex}
                                                            href={subItem.href}
                                                            className="block px-8 py-2 text-sm text-gray-600 hover:text-blue-600 hover:bg-gray-100 transition-colors"
                                                        >
                                                            {subItem.name}
                                                        </a>
                                                    ))}
                ...
                <div className="fixed inset-0 bg-black/30 bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-white rounded-lg p-8 max-w-sm mx-4 text-center">
                        ...
                        <p className="text-sm text-gray-600 mb-6">
                            You must log in again to apply language changes.
                        </p>
                        <button
                            onClick={redirectToLogin}
                            className="px-6 py-2 w-full bg-custom-yellow text-white rounded-md transition-colors"
                        >
                            OK
                        </button>
                    </div>
