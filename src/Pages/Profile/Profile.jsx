...
//     const { profile, countries, grades, sections } = useSelector(state => state.api)
//     const dispatch = useDispatch()
...
//     useEffect(() => {
//         if (editedData.grade_id) {
//             loadSections(editedData.grade_id)
//         }
//     }, [editedData.grade_id])
...
//             if (profileData.grade_id) {
//                 loadSections(profileData.grade_id)
//             }
//         }
//     }, [profile, allCountries])
...
//         try {
//             await dispatch(apiRequest({ 
//                 url: `api/sections/grade_id/${gradeId}`, 
//                 entity: "sections",
//                 headers: {
//                     "Accept-Language": localStorage.getItem('language') || 'en'
//                 }
...
//             case 'grade_id':
//                 if (userType === 'student' && !value) {
//                     error = t('validation.gradeRequired')
//                 }
//                 break
//             case 'section_id':
//                 if (userType === 'student' && !value) {
//                     error = t('validation.sectionRequired')
//                 }
//                 break
//         }
...
//     const handleSaveProfile = async () => {
//         // Validate all fields
//         const fieldsToValidate = ['name', 'email', 'country_id', 'governorate_id']
//         if (userType === 'student') {
//             fieldsToValidate.push('grade_id', 'section_id')
//         }
...
//     // Get options for autocomplete components
//     const governorateOptions = availableGovernorates.map(g => ({ 
//         value: g.id.toString(), 
//         label: g.name 
//     }))
...
//     const sectionOptions = (sections?.data?.data || []).map(s => ({ 
//         value: s.id.toString(), 
//         label: s.name 
//     }))
...
//                                     ? `${t('profile.student')} - ${profileData?.grade || ""} / ${profileData?.section || ""}` 
//                                     : `${t('profile.parentOf')} ${profileData?.child_name || ''}`}
//                             </p>
//                         </div>
//                         <div className='flex gap-2'>
//                             {!isEditing ? (
...
//                                     onClick={handleCancelEdit}
//                                     disabled={loading}
//                                     className='px-4 py-2 border border-gray-300 text-gray-700 rounded hover:bg-gray-50 transition-colors duration-200 disabled:opacity-50'
//                                 >
//                                     {t('profile.cancel')}
//                                 </button>
//                             )}
...
//                                         ) : (
//                                             <p className='p-3 bg-gray-50 rounded text-gray-900'>
//                                                 {profileData?.country || t('profile.selectCountry')}
//                                             </p>
//                                         )}
//                                     </div>
...
//                                         ) : (
//                                             <p className='p-3 bg-gray-50 rounded text-gray-900'>
//                                                 {profileData?.governorate || t('profile.selectGovernorate')}
//                                             </p>
//                                         )}
//                                     </div>
...
//                                                     <Autocomplete
//                                                         name="grade_id"
//                                                         placeholder={t('profile.selectGrade')}
//                                                         className={`${touched.grade_id && errors.grade_id ? 'border-red-500' : 'border-gray-200'}`}
//                                                         items={gradeOptions}
//                                                         value={editedData.grade_id || ''}
//                                                         onChange={(field, value) => {
//                                                             handleInputChange('grade_id', value)
//                                                             handleInputChange('section_id', '')
//                                                         }}
//                                                         onBlur={() => handleBlur('grade_id')}
//                                                         searchPlaceholder={t('profile.searchGrade')}
//                                                         noResultsText={t('profile.noGrade')}
//                                                     />
...
//                                                 </>
//                                             ) : (
//                                                 <p className='p-3 bg-gray-50 rounded text-gray-900'>{profileData?.grade}</p>
//                                             )}
//                                         </div>
//                                     )}
...
//                                                     <Autocomplete
//                                                         name="section_id"
//                                                         placeholder={t('profile.selectSection')}
//                                                         className={`${touched.section_id && errors.section_id ? 'border-red-500' : 'border-gray-200'}`}
//                                                         items={sectionOptions}
//                                                         value={editedData.section_id || ''}
//                                                         onChange={handleInputChange}
//                                                         onBlur={() => handleBlur('section_id')}
//                                                         disabled={!editedData.grade_id || sectionOptions.length === 0}
//                                                         searchPlaceholder={t('profile.searchSection')}
//                                                         noResultsText={!editedData.grade_id ? t('profile.selectGradeFirst') : t('profile.noSection')}
//                                                     />
//                                                     {touched.section_id && errors.section_id && (
//                                                         <div className="text-red-500 text-sm mt-1">{errors.section_id}</div>
//                                                     )}
//                                                 </>
//                                             ) : (
//                                                 <p className='p-3 bg-gray-50 rounded text-gray-900'>{profileData?.section}</p>
//                                             )}
//                                         </div>
//                                     )}
...
//                                     <div>
//                                         <label className='block text-sm font-medium text-gray-700 mb-2'>
//                                             {userType === 'student' ? t('profile.studentId') : t('profile.childStudentId')}
//                                         </label>
//                                         <p className='p-3 bg-gray-50 rounded text-gray-900'>{profileData?.id}</p>
//                                     </div>
...
//     const { profile, countries, grades } = useSelector(state => state.api)
//     // Get sections from Redux store
//     const sections = useSelector(state => state.api.sections?.data?.data || [])
//     const dispatch = useDispatch()
...
//     // Load sections when grade changes
//     useEffect(() => {
//         if (editedData.grade_id && isEditing) {
//             loadSections(editedData.grade_id)
//         }
//     }, [editedData.grade_id, isEditing])
...
//             // Load sections for current grade if editing
//             if (profileData.grade_id && isEditing) {
//                 loadSections(profileData.grade_id)
//             }
//         }
//     }, [profile, allCountries, isEditing])
...
//         } catch (error) {
//             console.error('Error loading sections:', error)
//             toast.error(t('profile.sectionsLoadError'))
//         } finally {
...
//             if (field === 'grade_id') {
//                 newData.section_id = ''
//                 // Load sections for the new grade
//                 if (value) {
//                     loadSections(value)
//                 } else {
...
//                                                         onChange={handleInputChange}
//                                                         onBlur={() => handleBlur('section_id')}
//                                                         disabled={!editedData.grade_id || sectionsLoading}
                            ...
                            <div className='space-y-6'>
                                ...
                                <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                                        ...
                                        {isEditing ? (
                                            <>
                                                <select
                                                    ...
                                                    onBlur={() => handleBlur('country_id')}
                                                    className={`w-full p-3 border rounded focus:outline-none focus:ring-2 focus:ring-yellow-500 ${
                                                        touched.country_id && errors.country_id ? 'border-red-500' : 'border-gray-200'
                                                    }`}
                                                    disabled={loading}
                                                >
                                            ...
                                            <>
                                                <select
                                                    ...
                                                    className={`
                                                        ...
                                                        w-full p-3 border rounded focus:outline-none  focus:ring-2 focus:ring-yellow-500 ${
                                                        touched.governorate_id && errors.governorate_id ? 'border-red-500' : 'border-gray-200'
                                                    }`}
                                                    disabled={!editedData.country_id || availableGovernorates.length === 0}
                                                >
                                                    <option value="">{t('profile.selectGovernorate')}</option>
                                                    {availableGovernorates.map(governorate => (
                                                        <option className='' key={governorate.id} value={governorate.id.toString()}>
                                                            {governorate.name}
                                                        </option>
                                                    ))}
                                                </select>
                                    ...
                                    {userType === 'student' && (
                                        <div>
                                            <label className='block text-sm font-medium text-gray-700 mb-2'>
                                                {i18n.language === 'ar' ? 'الصف الدراسي' :'Grade'}
                                            </label>
                                            {isEditing ? (
                                                <>
                                                    <select
                                                        ...
                                                        onBlur={() => handleBlur('grade_id')}
                                                        className={`w-full p-3 border rounded focus:outline-none focus:ring-2 focus:ring-yellow-500 ${
                                                            touched.grade_id && errors.grade_id ? 'border-red-500' : 'border-gray-200'
                                                        }`}
                                                    >
                                    ...
                                    {userType === 'student' && (
                                        <div>
                                            <label className='block text-sm font-medium text-gray-700 mb-2'>
                                               { i18n.language === 'ar' ? 'الفصل الدراسي' : 'Section' }
                                            </label>
                                            {isEditing ? (
                                                <>
                                                    <select
                                                        ...
                                                        onBlur={() => handleBlur('section_id')}
                                                        className={`w-full p-3 border rounded focus:outline-none focus:ring-2 focus:ring-yellow-500 ${
                                                            touched.section_id && errors.section_id ? 'border-red-500' : 'border-gray-200'
                                                        }`}
                                                        disabled={!editedData.grade_id || sectionsLoading || sections.length === 0}
                                                    >
                                                        <option value="">{t('profile.selectSection')}</option>
                                                    ...
                                                    {sectionsLoading && (
                                                        <div className="text-gray-500 text-sm mt-1">{t('profile.loadingSections')}</div>
                                                    )}
                                                </>
                                            ) : (
                                                <p className='p-3 bg-gray-50 rounded text-gray-900'>{profileData?.section}</p>
