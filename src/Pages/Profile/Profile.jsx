...
export default function ProfilePage({ UserType= 'student' }) {
    ...
    const [profileImagePreview, setProfileImagePreview] = useState(null) // New state for preview URL
            ...
            <div className='max-w-6xl mx-auto'>
                ...
                <div className='bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6'>
                    <div className='flex flex-col sm:flex-row items-center gap-6'>
                        <div className="relative">
                            {/* Avatar Circle */}
                            <div className="w-20 h-20 text-yellow-400 font-bold text-2xl bg-yellow-100 rounded-full flex items-center justify-center shadow-md overflow-hidden">
                                {/* {profileImagePreview ? (
                                    <img
                            ...
                            {/* {isEditing && (
                                <label className="absolute bottom-0 right-0 bg-yellow-500 text-white p-2 rounded-full cursor-pointer hover:bg-yellow-600 transition-colors shadow-lg">
                                    <input
                                        type="file"
                                        accept="image/*"
                ...
                <div className='bg-white rounded-lg shadow-sm border border-gray-200 mb-6'>
                    ...
                    <div className='p-6'>
                        ...
                        {activeTab === 'profile' && (
                            <div className='space-y-6'>
                                ...
                                <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                                    ...
                                    <div>
                                        <label className='block text-sm font-medium text-gray-700 mb-2'>
                                            {profileData?.type === '1' ? t('profile.studentCode') : t('profile.studentCode')}
                                        </label>
                        ...
                        {activeTab === 'reports' && profileData?.type === '1' && (
...
// export default function ProfilePage({ profileData?.type = 'student' }) {
//     const { t ,i18n} = useTranslation()
//     const [activeTab, setActiveTab] = useState('profile')
//     const [isEditing, setIsEditing] = useState(false)
//     const [editedData, setEditedData] = useState({})
...
//                 break
//             case 'grade_id':
//                 if (profileData?.type === 'student' && !value) {
//                     error = t('validation.gradeRequired')
//                 }
//                 break
//             case 'section_id':
...
//                         <div className="relative">
//   {/* Avatar Circle */}
//   <div className="w-20 h-20 text-yellow-400 font-bold text-2xl bg-yellow-100 rounded-full flex items-center justify-center shadow-md">
...
//                                     <div>
//                                         <label className='block text-sm font-medium text-gray-700 mb-2'>
//                                             {profileData?.type === 'student' ? t('profile.studentCode') : t('profile.studentCode')}
//                                         </label>
//                                         <p className='p-3 bg-gray-50 rounded text-gray-900'>{profileData?.child_code}</p>
//                                     </div>
...
//                         {/* Reports Tab (Students only) */}
//                         {activeTab === 'reports' && profileData?.type === 'student' && (
//                             <div className='space-y-8'>
//                                 {/* Academic Progress */}
//                                 <div>
//                                     <h2 className='text-xl font-semibold text-gray-900 mb-4'>{t('profile.academicProgress')}</h2>
